...
allwords = data.frame(table(strsplit(paste(mytext1,collapse=" ")," ")))
...
allwords <- allwords[!allwords[,1] %in% c('of','am','no','a','i','in',
                                          ...
                                          'their','non'),]
write.csv(allwords,file="output/wordfreq_locus.csv",row.names=FALSE)
...
allwords = data.frame(table(strsplit(paste(mytext2,collapse=" ")," ")))
allwords <- allwords[allwords[,1]!="",]
allwords <- allwords[!allwords[,1] %in% c('of','am','no','a','i','in',
                                          'and','have','with','as','to',
                                          'my','for','the','on','at','so',
                                          ...
                                          'are','don','which','them','what','such',
                                          'their','non'),]
write.csv(allwords,file="output/wordfreq_sust.csv",row.names=FALSE)

# Comments
mytext2 <- tolower(mysurveys$asctr_1_1_comments)
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_2_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_3_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_4_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_5_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_6_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_7_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_8_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_9_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$asctr_10_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$ci_1_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$ci_2_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$mri_1_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$og_1_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$rc_1_1_comments))
mytext2 <- c(mytext2 ,tolower(mysurveys$ts_1_1_comments))
...
allwords <- allwords[!allwords[,1] %in% c('of','am','no','a','i','in',
                                          ...
                                          'are','don','which','them','what','such',
                                          'their','non'),]
write.csv(allwords,file="output/wordfreq_comments.csv",row.names=FALSE)
