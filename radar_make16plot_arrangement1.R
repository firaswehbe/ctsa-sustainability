...
png(file=paste0("output/radar_loc_combined_16cats_1.png"),width=1800,height=1500,res=150)
...
png(file=paste0("output/radar_sust_combined_16cats_1.png"),width=1800,height=1500,res=150)
