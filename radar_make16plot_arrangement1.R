...
png(file=paste0("output/radar_loc_combined_16cats_1.png"),width=2400,height=2000,res=150)
...
title(main = "Locus of Control (Survey Order)", cex.main = 2)
...
png(file=paste0("output/radar_sust_combined_16cats_1.png"),width=2400,height=2000,res=150)
...
title(main = "Sustainability Model (Survey Order)", cex.main = 2)
