...
png(file=paste0("output/radar_loc_combined_16cats_2.png"),width=10.2,height=8.5,res=200, units = "in")
radarchart( mydata[c(1,2,3,4,5,6),]  , axistype=1 ,
            #custom line
            plwd=4 , pcol=CombinedPallette[1:4], plty=1, 
            #custom the grid
            cglcol="grey40", cglty=1, axislabcol="grey40", seg=5, caxislabels=seq(0,50,10), cglwd=0.8,
            #custom labels
            vlcex=1.2
)
...
png(file=paste0("output/radar_sust_combined_16cats_2.png"),width=10.2,height=8.5,res=200, units = "in")
